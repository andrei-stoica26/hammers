...
1) Functions (getters and setters) that can equally operate on Seurat and
SingleCellExperiment objects, intended to help developers build tools 
compatible with both types of input.

2) Other simple tools to address common tasks in scRNA-seq data analysis. These
tasks include:

- Aggregate gene statistics.
- The selection and removal of rare genes.
- Multiple testing correction.
- Silhouette and cluster-normalized silhouette calculation.
