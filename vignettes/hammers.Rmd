...
development. The goal of hammers is twofold:

1) Provide a series of functions that can equally operate on Seurat and
SingleCellExperiment objects. These functions are intended to help
